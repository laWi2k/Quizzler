...
struct QuestionsForQuiz {
    ...
    static let questions = [QuestionsForQuiz(question: "There are 4 Maxwell's equations, right?", correctAnswer: true, isUsedBefore: false),
...
class ViewController: UIViewController {
    ...
    func updateUILabel() {
        ...
        guard let question = QuestionsForQuiz.questions.randomElement(), !question.isUsedBefore else {
            return
        }
        
        
        labelView.text = question.question
        //labelView.text = Array(quizQuestions.keys)[questionNumber]
    }
    ...
    @objc func keyFalsePressedDown(){
        ...
        if questionNumber + 1 < QuestionsForQuiz.questions.count {
                    questionNumber += 1
                } else {
                    questionNumber = 0
                }
